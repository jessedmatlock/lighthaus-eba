	...
	<section id="landing-intro" class="short-intro">
		<div class="row">
		    <div class="small-12 medium-12 large-12 columns">
				...
				<h1 class="">See Why at the EBA We Mean Business!</h1>
		    </div><!-- end columns -->
		</div><!-- end row -->
		    ...
		    <div class="small-12 medium-12 large-12 columns">
				...
				<form action="#apply" method="POST" accept-charset="utf-8" data-abide enctype="multipart/form-data">
					...
					<div class="row">
					    ...
					    <div class="small-12 medium-6 large-6 columns">
						<label>
					        <input type="text" name="email"  id="email" value="" placeholder="EMAIL ADDRESS" required pattern="^[a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+$" />
